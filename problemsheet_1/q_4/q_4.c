...
int main()
{
    int ch, adder ;// ch use of choice if switch case , adder use for case 1 for add book up to n;
...
{
    printf("|%d\t\t|%s\t\t|%s\t\t|%d\t\t|%s\t\t|\n", b.accession, b.title, b.author, b.prise, b.issued ? "Yes" : "No");
}

void looktitle()
{
    printf("---------------------------------------------------------------------------------\n");
    printf("|accession No.\t|Books Title\t|Author Name\t|Price\t\t|Issued Status\t|\n");
    printf("---------------------------------------------------------------------------------\n");
    return;
}
void lookend()
